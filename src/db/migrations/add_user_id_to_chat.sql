...
-- Update existing Chat records to set user_id from related Concept records
...
-- Fix the update_learning_streak function to work with TEXT user_id
...
-- To enable it, run: ALTER TABLE "Message" ENABLE TRIGGER trigger_update_learning_streak; 