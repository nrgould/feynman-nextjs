...
export default function FeaturesSection() {
	...
	return (
		<section className='relative w-full min-h-[60dvh] md:min-h-[90dvh] py-12 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-emerald-400 from-50% to-emerald-500'>
			{/* Center graphic */}
			<div className='mx-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px]'>
			...
			<div className='container relative px-4 md:px-6  mx-auto'>
				...
				<div className='w-full relative max-w-8xl'>
					{/* Orbiting cards */}
					<div className=' mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12'>
                 ...
                 ${index === 0 ? 'lg:translate-y-12 lg:translate-x-36' : ''}
                 ${index === 1 ? 'lg:translate-y-96' : ''}
                  ${index === 2 ? 'lg:translate-y-12 lg:-translate-x-36' : ''}
                `}
							>
								<CardHeader className='space-y-4 pb-2'>
									<div className='flex items-center gap-4'></div>
									<CardTitle className='text-emerald-50 text-2xl'>
										{feature.title}
									</CardTitle>
								</CardHeader>
								<CardContent>
