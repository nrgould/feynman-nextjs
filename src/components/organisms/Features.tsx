				...
				<div className='grid md:grid-cols-3 gap-12'>
					<div>
						...
						<ul className='space-y-3 text-muted-foreground list-disc pl-4'>
							<li>
								Strengthens memory through systematic practice
								and review
							</li>
							<li>
					...
					<div>
						...
						<ul className='space-y-3 text-muted-foreground list-disc pl-4'>
							<li>Follow your natural curiosity and interests</li>
							<li>
								Discover connections between different concepts
							</li>
							<li>
								Learn through guided exploration and discovery
							</li>
						</ul>
					</div>
					...
					<div>
						...
						<ul className='space-y-3 text-muted-foreground list-disc pl-4'>
							<li>Personalized pace based on your progress</li>
							<li>
								Adjusts difficulty to match your understanding
							</li>
							<li>
			...
			<div className='container mx-auto bg-slate-50 rounded-2xl p-8'>
				<div className='max-w-3xl mx-auto'>
					...
					<p className='text-lg text-muted-foreground text-center'>
						Many students using AI tools like ChatGPT for math score
						lower on tests. Why? They prioritize quick answers over
						real understanding. Our system flips the script, using
						AI to foster true learning, not shortcuts.
					</p>
				</div>
			</div>
		</div>
